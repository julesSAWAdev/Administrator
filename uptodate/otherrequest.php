                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                       ...
                       <div class="sparkline13-list">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        $row = mysqli_fetch_array($res,MYSQLI_ASSOC);
                                          ...
                                          $shop_id = $row['shopid'];
                                              ...
                                              $sql1 = "SELECT * FROM other_request_tbl WHERE shop_id = '$shop_id' AND status ='0' ORDER BY request_id DESC"; 
                        ...
                        echo $rowww['phone'];
                                    ...
                                    <a href="otherdeliver.php?id=<?php echo $roww['request_id']?>"><button type="button" class="btn btn-success">Delivered</button></a>
